// [AIV_SHORT]  Build version: 0.0.1 - Tuesday, October 30th, 2018, 3:41:54 PM  
 (function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["nymphea"] = factory();
	else
		root["nymphea"] = factory();
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(80) ], __WEBPACK_AMD_DEFINE_RESULT__ = (function() {
	"use strict";
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var _usedDependencyAlert = __webpack_require__(72);

var _usedDependencyAlert2 = _interopRequireDefault(_usedDependencyAlert);
...
var AlertYClass = function () {
    function AlertYClass() {
        _classCallCheck(this, AlertYClass);

        var PROJECT = window.project_name || "noNameProject";
        var PREFIX = "AlertY   " + PROJECT;
    ...
    _createClass(AlertYClass, [{
        key: 'error',
        value: function error(message, props) {
            if (isDEVELOP) {
            ...
            if (props && props.needAlert) {
                _usedDependencyAlert2.default.error(message);
        ...
        key: 'warning',
        value: function warning(message, props) {
            if (isDEVELOP) {
                console.log("%c ----- DEVELOP LOG start", 'color: #033E6B; font-weight: bold;');
            ...
            if (props && props.needAlert) {
                _usedDependencyAlert2.default.warning(message);
        ...
        key: 'message',
        value: function message(_message, props) {
            if (props && props.onlyDev) {
                if (isDEVELOP) console.info("%c" + this.MessageName.message + " : " + _message, 'color: #3598AB; font-weight: bold;');
            }
            if (props && props.needAlert) {
                _usedDependencyAlert2.default.message(_message);
                console.log("%c" + this.MessageName.message + " : " + _message, 'color: #3598AB; font-weight: bold;');
            }
            if (_.isEmpty(props)) {
                console.info("%c" + this.MessageName.message + " : " + _message, 'color: #3598AB; font-weight: bold;');
            }
        }
    }, {
        key: 'success',
        value: function success(message, props) {
            if (props && props.onlyDev) {
                if (isDEVELOP) {
            ...
            if (props && props.needAlert) {
                _usedDependencyAlert2.default.success(message);
                console.log("%c" + this.MessageName.success + " : " + message, 'color: #0C8155; font-weight: bold;');
            }
...
var AlertY = new AlertYClass();

exports.default = AlertY;
...
var LoaderFactory = exports.LoaderFactory = {
	loaders: [],
	default_error: null,
	get: function get(url, params, request_method) {
		var loader = new _Loader2.default(url, params, request_method, this.default_error);
	...
	setDefaultError: function setDefaultError(cb) {
...
var _alerty = __webpack_require__(20);

var _alerty2 = _interopRequireDefault(_alerty);

var _routeClass = __webpack_require__(74);

var _routeClass2 = _interopRequireDefault(_routeClass);

var _modelClass = __webpack_require__(76);

var _modelClass2 = _interopRequireDefault(_modelClass);

var _handlerClass = __webpack_require__(117);

var _handlerClass2 = _interopRequireDefault(_handlerClass);

var _controllerClass = __webpack_require__(118);
...
var _LoaderFactory = __webpack_require__(68);
...
var nymphea = function nymphea() {
  _classCallCheck(this, nymphea);
};

var NYMPHEA = new nymphea();

NYMPHEA.ALERTY = _alerty2.default;
NYMPHEA.ROUTE = _routeClass2.default;
NYMPHEA.MODEL = _modelClass2.default;
NYMPHEA.HANDLER = _handlerClass2.default;
NYMPHEA.CONTROLLER = _controllerClass2.default;
//NYMPHEA.COMPONENT   = COMPONENT;
NYMPHEA.VALUES = _main2.default;

NYMPHEA.LoaderFactory = _LoaderFactory.LoaderFactory;

exports.default = NYMPHEA;
...
var notify;
try {
    alertify = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../node_modules/alertifyjs/build/alertify.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
} catch (err) {
    alertify = null;
}
if (alertify) {
...
try {
    notify = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../node_modules/devextreme/ui/notify.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
} catch (err) {
    notify = null;
}

var UsedDependencyAlert = function () {
    function UsedDependencyAlert() {
        _classCallCheck(this, UsedDependencyAlert);
    ...
    _createClass(UsedDependencyAlert, [{
        key: 'error',
        ...
        value: function message(_message) {
            if (notify) {
                notify(_message, "message", this.DALAY);
            } else if (alertify) {
    ...
    return UsedDependencyAlert;
}();

var Alert = new UsedDependencyAlert();
    ...
    _createClass(ROUTE, [{
        ...
        value: function route() {
            ...
            _.each(patches, function (node, key) {
                if (SELF[node]) {
                    _route2.default.map(key).to(function () {
                        SELF[node]();
                    });
                }
            });
...
var Path = { //https://github.com/mtrpcic/pathjs
    'version': "0.8.4",
...
var Model = function () {
    ...
    _createClass(Model, [{
        key: 'setUseAlternativeRequestParams',
        value: function setUseAlternativeRequestParams() {
        ...
        key: 'setCtrlCtrl',
        value: function setCtrlCtrl(ctrl) {
            //используется в формировании url
            this.CTRL = ctrl;
        }
    }, {
        key: 'setTargetCtrl',
        value: function setTargetCtrl(target) {
            //используется в формировании url
            this.TARGET = "/" + target;
        }
    }, {
        key: 'setMethodCtrl',
        value: function setMethodCtrl(method) {
            //используется в формировании url
            this.METHOD = "/" + method;
        }
    }, {
        ...
        value: function create(data) {
            ...
            var url = SELF.baseUrl() + SELF.CTRL;
            ...
            SELF.requestCreate = _LoaderFactory.LoaderFactory.get(url, SELF.toServerProcess(data) || {}, request_method);
            SELF.promiseCreate = new Promise(function (resolve, reject) {
                SELF.requestCreate.success(function (data) {
        ...
        key: 'getPromiseCreate',
        value: function getPromiseCreate() {
        ...
        value: function read(data) {
            ...
            SELF.requestRead = _LoaderFactory.LoaderFactory.get(url, data || {}, request_method);
            SELF.promiseRead = new Promise(function (resolve, reject) {
                SELF.requestRead.success(function (data) {
                    SELF.toModelProcess(data);
                    resolve();
                }).error(function (msg) {
                    reject(msg);
        ...
        value: function update(data) {
            ...
            SELF.requestUpdate = _LoaderFactory.LoaderFactory.get(url, SELF.toServerProcess(data) || {}, request_method);
            SELF.promiseUpdate = new Promise(function (resolve, reject) {
                SELF.requestUpdate.success(function (data) {
                    SELF.toModelProcess(data);
                    resolve();
                }).error(function (msg) {
                    reject(msg);
        ...
        key: 'getPromiseUpdate',
        value: function getPromiseUpdate() {
        ...
        value: function _delete(data) {
            ...
            SELF.requestDelete = _LoaderFactory.LoaderFactory.get(url, data || {}, request_method);
            SELF.promiseDelete = new Promise(function (resolve, reject) {
                SELF.requestDelete.success(function (request) {
        ...
        key: 'getPromiseDelete',
        value: function getPromiseDelete() {
            return this.promiseDelete;
        }
    }, {
        key: 'toModelProcess',
        value: function toModelProcess() {}
    }, {
        key: 'toServerProcess',
        value: function toServerProcess() {}
    }, {
        key: 'set',
        value: function set() {}
    }, {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
	...
	var Loader = function Loader(url, params, request_method, default_error) {
		...
		self.xhr = $.ajax({
			...
			error: function error(xhr, status, _error) {
				self._done(null, false, _error);
				self._error(_error, xhr.responseText);
			}
		});
	};
...
var Handler = function () {
    ...
    _createClass(Handler, [{
        ...
        value: function setState(data) {
            if (!data) {
                _alerty2.default.error("I Can't setProps in " + this.HandlerName + ", i haven't data");return;
            }
            if (!_.isObject(data)) {
                _alerty2.default.error("I Can't setProps in " + this.HandlerName + ", data must be object");return;
            }
        ...
        key: 'setCB',
        value: function setCB(key, cb) {
            if (!key) {
                _alerty2.default.error("I Can't setUserCB in " + this.HandlerName + ", i haven't key");return;
            }
            if (!cb) {
                _alerty2.default.error("I Can't setUserCB in " + this.HandlerName + ", i haven't cb");return;
            }
            if (this.CBS[key]) {
                _alerty2.default.warning("CB c ключом " + key + " уже существует и был перезаписан", { onlyDev: true });
            }
            this.CBS[key] = cb;
        }
    }, {
        key: 'getCB',
        value: function getCB(key) {
            if (!key) {
                _alerty2.default.error("I Can't getUserCB in " + this.HandlerName + ", i haven't key");return;
            }
            if (!this.CBS[key]) {
                _alerty2.default.warning("CB with a key " + key + " not found");
            }
            return this.CBS[key];
        }
    }]);
...
var Controller = function () {
    ...
    _createClass(Controller, [{
        ...
        key: "getRenderPromise",
        value: function getRenderPromise() {
            var SELF = this;
...
var _getArray = __webpack_require__(120);

var _getArray2 = _interopRequireDefault(_getArray);

var _getObject = __webpack_require__(121);
...
var ValuesClass = function ValuesClass() {
  _classCallCheck(this, ValuesClass);
};

;
var VALUES = new ValuesClass();

VALUES.getArray = _getArray2.default;
VALUES.getObject = _getObject2.default;
...
function GetType(newData) {
    ...
    var errorAlert = function errorAlert(text, orData) {
        _alerty2.default.error("Data type error! " + text + " instead of ARRAY! Now use ", orData);
    };

    this.newData = newData;
    this.or = function () {
        var orData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

        var returnedArr = this.newData;
        switch (this.newData) {
            case null:
                returnedArr = orData;errorAlert("NULL", orData);break;
            case undefined:
                returnedArr = orData;errorAlert("undefined", orData);break;
        }
...
function GetType(newData) {
    if (!(this instanceof GetType)) return new GetType(newData);
    var errorAlert = function errorAlert(text, orData) {
        _alerty2.default.error("Data type error! " + text + " instead of OBJECT! Now use ", orData);
    };
...
//# sourceMappingURL=nymphea.v_0.0.1.js.map 