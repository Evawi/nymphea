// [AIV_SHORT]  Build version: 0.0.0 - Wednesday, October 17th, 2018, 3:34:20 PM  
 var index =
...
var initialize = function initialize() {
    var initializeINDEX = function (_INDEX) {
        _inherits(initializeINDEX, _INDEX);

        function initializeINDEX() {
            _classCallCheck(this, initializeINDEX);

            return _possibleConstructorReturn(this, (initializeINDEX.__proto__ || Object.getPrototypeOf(initializeINDEX)).apply(this, arguments));
        }

        _createClass(initializeINDEX, [{
            key: 'patches',
    ...
    }(_indexClass2.default);

    var initializeINDEXCTR = new initializeINDEX();
